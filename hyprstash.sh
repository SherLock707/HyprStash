...
# Usage: ./hyprstash.sh [-d] <terminal_command>
# Example: ./hyprstash.sh foot
#          ./hyprstash.sh -d foot (with debug output)
#          ./hyprstash.sh "kitty -e zsh"
#          ./hyprstash.sh "alacritty --working-directory /home/user"

DEBUG=false
SPECIAL_WS="special:scratchpad"
ADDR_FILE="/tmp/hyprstash_terminal_addr"

# hyprstash size and position configuration (percentages)
...
# Function to calculate hyprstash position
calculate_hyprstash_position() {
...
spawn_terminal() {
    debug_echo "Creating new hyprstash terminal with command: $TERMINAL_CMD"
    
    # Calculate hyprstash position for later use
    pos_info=$(calculate_hyprstash_position)
